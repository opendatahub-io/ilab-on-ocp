...
def test_taxonomy_repo(
    ...
    return dsl.ContainerSpec(
        ...
        [
            ...
            export {http_proxy_env_var_name}={http_proxy_env_var_value}
            export {https_proxy_env_var_name}={https_proxy_env_var_value}
            export {no_proxy_env_var_name}={no_proxy_env_var_value}
